...
export const env = createEnv({
  ...
  server: {
    ...
    PROCESS_VIDEO_ENDPOINT_AUTH: process.env.NODE_ENV === "production" ? z.string() : z.string().optional(),
    BASE_URL: process.env.NODE_ENV === "production" ? z.string() : z.string().optional(),
  },
